...
public class FacePamphletDatabase implements FacePamphletConstants {
    ...
    public void deleteProfile(String name) {
        if (!database.containsKey(name)) {
            ...
            FacePamphletProfile deletedProfile = database.get(name);
            Iterator<String> it = deletedProfile.getFriends();
            while(it.hasNext()) {
                String friendName = it.next();
                FacePamphletProfile friendProfile = database.get(friendName);
